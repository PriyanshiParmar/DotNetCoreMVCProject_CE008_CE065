...
namespace HospitalManagement.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AppointmentId,Date,Status,AppointmentTime,PatientId,DoctorId")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AppointmentId,Date,Status,AppointmentTime,PatientId,DoctorId")] Appointment appointment)
        {
